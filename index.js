...
readdir(folderPath, (err, files) => {
    ...
    audioFiles.forEach((file) => __awaiter(void 0, void 0, void 0, function* () {
        const audioFilePath = `${folderPath}/${file}`;
        readFile(audioFilePath, (err, buffer) => __awaiter(void 0, void 0, void 0, function* () {
            if (err) {
                console.error(`❌ Error reading file ${file}:`, err.message);
                return;
            }
            try {
                const audioBuffer = yield convertToAudioBuffer(buffer);
                console.log(`\n🎵 Processing: ${file}`);
                ...
                const downsampledArray = downsampleArray(audioMono, audioBuffer.sampleRate, Down_Sample_RATE);
 ...
 */
function convertToAudioBuffer(buffer) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const audioBuffer = yield decode(new Uint8Array(buffer));
            return audioBuffer;
        }
        catch (error) {
 ...
 */
function detectBPM(vectorFloat, sampleRate) {
    const computed = essentia.PercivalBpmEstimator(vectorFloat, undefined, // frameSize (default)
...
function detectDanceability(vectorFloat, sampleRate) {
    const computed = essentia.Danceability(vectorFloat, undefined, undefined, sampleRate, undefined);
